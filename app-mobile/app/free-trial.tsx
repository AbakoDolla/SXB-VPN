...
import { alpha, radius, responsiveLayout, spacing } from "@/constants/theme";
import {
...
function makeStyles(colors: ReturnType<typeof import("@/hooks/useColors").useColors>, responsive: ReturnType<typeof useResponsive>) {
  return StyleSheet.create({
    ...
    logoHalo: { width: 82, height: 82, borderRadius: radius.xl, backgroundColor: colors.primaryDim, borderWidth: 1, borderColor: colors.primary + "45", alignItems: "center", justifyContent: "center", marginBottom: 18 },
    ...
    formCard: { backgroundColor: colors.bgCard + "F2", borderWidth: 1, borderColor: colors.border, borderRadius: radius.xl, padding: responsive.cardPadding, gap: spacing.lg },
    ...
    inputRow: { flexDirection: "row", alignItems: "center", gap: spacing.md, backgroundColor: colors.bgInput, borderWidth: 1, borderColor: colors.border2, borderRadius: radius.md, paddingHorizontal: 14 },
    ...
    assuranceBar: { flexDirection: responsive.isCompact ? "column" : "row", alignItems: "stretch", backgroundColor: colors.bgCard + "D9", borderWidth: 1, borderColor: colors.border, borderRadius: radius.lg, paddingVertical: 16, paddingHorizontal: 8 },
    assuranceCell: { flex: 1, alignItems: "center", gap: spacing.sm, paddingHorizontal: 6, paddingVertical: responsive.isCompact ? 8 : 0 },
    assuranceIcon: { width: 34, height: 34, borderRadius: radius.sm, borderWidth: 1, alignItems: "center", justifyContent: "center", marginBottom: 2 },
    ...
    modalCard: { flex: 1, backgroundColor: colors.bg, borderTopLeftRadius: 24, borderTopRightRadius: 24, borderWidth: 1, borderColor: colors.border, paddingHorizontal: 18, paddingTop: 16, gap: spacing.md },
    modalHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
    modalTitle: { color: colors.textPrimary, fontSize: 17, fontFamily: "Inter_700Bold" },
    modalList: { flex: 1 },
    countryRow: { flexDirection: "row", alignItems: "center", gap: spacing.md, paddingVertical: 13, borderBottomWidth: 1, borderBottomColor: colors.border },
    ...
    errorWrap: { flexDirection: "row", alignItems: "center", gap: spacing.sm },
    ...
    statusCard: { backgroundColor: colors.bgCard + "F2", borderWidth: 1, borderColor: colors.border, borderRadius: radius.xl, padding: 22, gap: spacing.md, alignItems: "center" },
    statusOrb: { width: 92, height: 92, borderRadius: radius["2xl"], backgroundColor: colors.bgInput, alignItems: "center", justifyContent: "center", marginBottom: 6 },
    ...
    summaryRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", alignSelf: "stretch", gap: spacing.md, paddingTop: 6 },
    ...
    deviceCard: { flexDirection: "row", alignItems: "center", flexWrap: "wrap", gap: spacing.md, backgroundColor: colors.bgCard + "D9", borderWidth: 1, borderColor: colors.border, borderRadius: radius.lg, padding: 14 },
    deviceIcon: { width: 38, height: 38, borderRadius: radius.md, backgroundColor: colors.primaryDim, alignItems: "center", justifyContent: "center" },
    deviceCopy: { flex: 1, gap: spacing.xs },
