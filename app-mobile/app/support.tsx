...
const styles = StyleSheet.create({ container: { flex: 1 }, content: { paddingHorizontal: 20, gap: 10 }, hero: { alignItems: "center", gap: 9, borderRadius: 24, borderWidth: 1, padding: 23, marginBottom: 8 }, heroIcon: { width: 78, height: 78, borderRadius: 28, borderWidth: 1, alignItems: "center", justifyContent: "center", marginBottom: 3 }, eyebrow: { fontSize: 10, fontFamily: "Inter_700Bold", letterSpacing: 1.5 }, heroTitle: { fontSize: 22, fontFamily: "Inter_700Bold" }, heroSub: { fontSize: 13, lineHeight: 19, fontFamily: "Inter_400Regular", textAlign: "center" }, heroButton: { minHeight: 48, flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 18, borderRadius: 14, marginTop: 3 }, heroButtonText: { fontSize: 13, fontFamily: "Inter_700Bold" }, errorCard: { flexDirection: "row", alignItems: "center", gap: 9, padding: 13, borderWidth: 1, borderRadius: 15 }, errorText: { flex: 1, fontSize: 12, lineHeight: 18, fontFamily: "Inter_400Regular" }, sectionHeader: { flexDirection: "row", alignItems: "center", gap: 8, paddingLeft: 4, paddingTop: 8, marginBottom: 3 }, sectionIcon: { width: 28, height: 28, borderRadius: 10, borderWidth: 1, alignItems: "center", justifyContent: "center" }, sectionTitle: { flex: 1, fontSize: 14, fontFamily: "Inter_700Bold" }, card: { borderRadius: 19, borderWidth: 1, padding: 14, gap: 10 }, input: { minHeight: 48, borderWidth: 1, borderRadius: 13, paddingHorizontal: 13, paddingVertical: 11, fontSize: 13, fontFamily: "Inter_400Regular" }, textarea: { minHeight: 105, paddingTop: 13 }, sendButton: { minHeight: 48, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, borderRadius: 13 }, sendText: { fontSize: 13, fontFamily: "Inter_700Bold" }, successText: { fontSize: 12, textAlign: "center", fontFamily: "Inter_500Medium" }, disabled: { opacity: 0.48 }, ticketCard: { borderRadius: 17, borderWidth: 1, padding: 14, gap: 7, marginBottom: 9 }, ticketTop: { flexDirection: "row", alignItems: "center", gap: 8, flexWrap: "wrap" }, ticketTitle: { flex: 1, minWidth: 150, fontSize: 14, fontFamily: "Inter_600SemiBold" }, statusBadge: { borderWidth: 1, borderRadius: 99, paddingHorizontal: 8, paddingVertical: 4 }, statusText: { fontSize: 10, fontFamily: "Inter_600SemiBold" }, ticketMessage: { fontSize: 12, lineHeight: 18, fontFamily: "Inter_400Regular" }, ticketDate: { fontSize: 10, fontFamily: "Inter_400Regular" }, emptyCard: { minHeight: 90, alignItems: "center", justifyContent: "center", gap: 8, borderRadius: 17, borderWidth: 1 }, emptyText: { fontSize: 12, fontFamily: "Inter_400Regular" }, faqItem: { minHeight: 48, paddingVertical: 14, gap: 8 }, faqQuestion: { flexDirection: "row", alignItems: "center", gap: 8 }, faqQuestionText: { flex: 1, fontSize: 13, fontFamily: "Inter_600SemiBold" }, faqAnswer: { fontSize: 13, lineHeight: 20, fontFamily: "Inter_400Regular", paddingLeft: 26 }, divider: { height: 1 }, pressed: { opacity: 0.7, transform: [{ scale: 0.99 }] },
});
