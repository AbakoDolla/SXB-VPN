...
const TABS = [
  { id: "ssh", label: "technical.ssh.title", icon: Terminal, desc: "technical.engine.sshDescription", roles: ["SUPER_ADMIN", "ADMIN", "SUPPORT"] },
  { id: "payload", label: "technical.payload.title", icon: Code2, desc: "technical.engine.payloadDescription", roles: ["SUPER_ADMIN", "ADMIN"] },
  { id: "xray", label: "technical.engine.xrayTab", icon: Zap, desc: "technical.xray.subtitle", roles: ["SUPER_ADMIN", "ADMIN"] },
  { id: "singbox", label: "technical.engine.singboxTab", icon: Box, desc: "technical.engine.singboxDescription", roles: ["SUPER_ADMIN", "ADMIN"] },
];
    ...
    <div className="space-y-5">
      ...
      <div>
        <div className="flex items-center gap-2 mb-1">
          ...
          <h1 className="text-xl font-bold text-white tracking-tight">{t("technical.engine.title")}</h1>
        </div>
        <p className="text-xs text-gray-500">{t("technical.engine.subtitle")}</p>
      </div>
