...
const configSchema = z.object({
  ...
  XPANEL_URL: z.string().url().default("https://xpanel.example.com"),
  XPANEL_TOKEN: z.string().default("fallback_xpanel_token"),
...
export const config = parsed.success ? parsed.data : configSchema.parse({
  ...
  XPANEL_URL: process.env.XPANEL_URL || "https://xpanel.example.com",
  XPANEL_TOKEN: process.env.XPANEL_TOKEN || "fallback_xpanel_token",
